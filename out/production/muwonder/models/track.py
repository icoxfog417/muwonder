...
class Track(ItemEvaluator, JsonSerializable):
    """
    ...
    def __init__(self, item=None):
        ...
        """
        super(Track, self).__init__(item)
        ...
        self.set_rule({"elapsed": Track.calc_less_is_better})
        self.set_rule({"genre_score": Track.calc_near_is_better})
        self.set_rule({"bpm": Track.calc_near_is_better})
        self.set_rule({"comment_count": Track.calc_more_is_better})
        self.set_rule({"download_count": Track.calc_more_is_better})
        self.set_rule({"playback_count": Track.calc_more_is_better})
        self.set_rule({"favoritings_count": Track.calc_more_is_better})
